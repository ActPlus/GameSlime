...
public class Triangle extends Entity {
    ...
    private Random rand;
    private PolygonRenderer graphics;
    private Color color;
    ...
    public Triangle(GameScreen screen, Vector2 []  vertices, OrthographicCamera camera) {
        ...
        System.out.println(this.getVertices()[0].cpy() + " " +this.getVertices()[1].cpy() + " " + this.getVertices()[2].cpy());
        this.graphics = new PolygonRenderer(this.getVertices(),3,color);
    }
    ...
    public static float getArea(Vector2[] vertices)
    {
        if(vertices.length!=3){
            System.err.println("Triangle2 get Area only works on triangles!!! ");
        }
